...
import com.levifralex.mapper_v2.enums.TodoStateEnum;
import com.levifralex.mapper_v2.exceptions.ResourceNotFoundException;
import com.levifralex.mapper_v2.mapper.TodoMapper;
import com.levifralex.mapper_v2.mapper.UserMapper;
import com.levifralex.mapper_v2.repository.TodoRepository;
...
public class TodoServiceImpl implements TodoService {
	...
	public List<TodoDTO> findAll() throws ServiceException {
		return todoMapper.toDTOList(todoRepository.findAllActives());
	}
	...
	public List<TodoDTO> findByLikeDescription(String description) throws ServiceException {
		try {
			return todoMapper.toDTOList(todoRepository.findByLikeDescription("%" + description + "%"));
		} catch (Exception e) {
